...
## The parameters are given, not chosen

- **beta, gamma, source, t0** — properties of the outbreak
- **delta_t** — delay before the immunization takes effect
- **m** — doses, as a fraction of the network (0.2, per the paper); an integer
  above 1 is read as an absolute count
- **n_samples** — ensemble size

Agents do not select, tune, or extend them. To evaluate a different scenario,
edit this file.

## The strategies

Three, fixed, as the paper defines them:
